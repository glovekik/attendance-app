 ...
 *   Employee Attended (teal) · Sick/PTO (blue) · Unpaid PTO (orange) ·
 *   No show/No call (dark) · Non-working/Public holiday (gold)
 *
...
export type AttCat = "present" | "wfh" | "leave" | "unpaid" | "absent" | "holiday";

// Fully-saturated colors (dots, bars, borders, filled pills). Hues are kept
// well-separated around the wheel: green · violet · blue · red-orange · slate ·
// amber — with a letter badge on each calendar card as an extra cue.
