...
const ALL_COMMANDS: Command[] = [
  ...
  },
  {
    id: "org",
    label: "Organization",
    description: "Browse departments, projects and who's on them",
    icon: "people-circle-outline",
    route: "/org-chart",
    keywords: ["org", "chart", "hierarchy", "structure", "department"],
    section: "navigation",
  },
  {
    id: "chat",
    label: "Chats",
    description: "Office and project conversations",
    icon: "chatbubbles-outline",
    route: "/chat",
    keywords: ["message", "team", "project", "office"],
    section: "navigation",
  },
  {
    id: "notifications",
